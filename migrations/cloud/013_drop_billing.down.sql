...
-- Recreate the billing, shop and VAT schema exactly as migrations 005 and 011 left it.
--
-- Reproduced verbatim from those files rather than paraphrased: golang-migrate cannot
-- include one migration from another, and a down migration that drifts from the up it
-- reverses is worse than no down migration at all.
