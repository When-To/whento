...
-- Recreate the licences table exactly as migration 005 left it.
--
-- Reproduced verbatim rather than paraphrased: golang-migrate cannot include one
-- migration from another, and a down that drifts from the up it reverses is worse than
-- no down at all.
